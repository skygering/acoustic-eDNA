...
Sv1 = raw_data.get_Sv(calibation=cal_obj1, return_depth=True)
...
cal_obj2.transducer_offset_z = 7.5
Sv2 = raw_data.get_Sv(calibation=cal_obj2, return_depth=True)
...
cal_obj3.drop_keel_offset = 7.5
cal_obj3.transducer_mounting = "DropKeel"
Sv3 = raw_data.get_Sv(calibation=cal_obj3, return_depth=True)
...
Sv4 = raw_data.get_Sv(calibation=cal_obj4, return_depth=False)
Sv4.transducer_draft = np.full(len(Sv4.ping_time), 7.5) # sets transducer depth to 7.5 manually
...
axs[1,1].set_ylim(bottom = 25 + 7.5)
